   ...
   log "Building Docker image..."
    ...
    safe_run docker build -t sre-abc-training-python-app:amd64 .
   ...
   safe_run kubectl wait --for=condition=Ready pods --all --all-namespaces --timeout=180s || { log "Timeout, seguimos..."; true; }
